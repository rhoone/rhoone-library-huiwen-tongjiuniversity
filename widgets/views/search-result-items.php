...
use rhoone\library\providers\huiwen\targets\tongjiuniversity\widgets\SearchResultItem;
...
<div class="alert alert-warning alert-dismissible" role="alert">
    ...
    <strong>注意！</strong> 检索内容基于<a href="http://webpac.lib.tongji.edu.cn">同济大学图书馆</a>2019年5月1日的数据。因此，图书的“借阅状态”仅供参考；在此之后新入藏的书籍可能无法被检索到。
</div>
